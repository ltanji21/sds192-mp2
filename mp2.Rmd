...
>>>>>>> 46a55770ff989ab7e2ad7e9766a214e63de1da27
```
...
```{r}
ggplot(percentage_parties, aes(y = 0, x = Dem)) + geom_point(position = "jitter", colour = "blue", shape = 1, size = 2) + xlab("Democratic candidates") + labs(title = "Percentage of Democratic incumbant candidates reelected by state") + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.y = element_blank()) + scale_y_discrete(breaks=c("-0.1","0","0.1"))
```

```{r}
ggplot(percentage_parties, aes(y = 0, x = Rep)) + geom_point(position = "jitter", colour = "red", shape = 1, size = 2) + xlab("Republican candidates") + labs(title = "Percentage of Republican incumbant candidates reelected by state") + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.y = element_blank()) + scale_y_discrete(breaks=c("-0.1","0","0.1"))
```
...
Dem_states + labs(title = "Percentage of Democratic incumbant candidates reelected by state") + xlab("Percentage of incumbant candidates reelected") + ylab("Number of states")
```
Figure 4: The distribution of percentages of Democratic incumbent candidates being reelected by state
...
Rep_states + labs(title = "Percentage of Republican incumbant candidates reelected by state") + xlab("Percentage of incumbant candidates reelected") + ylab("Number of states")
```
Figure 5: The distribution of percentages of Republican incumbent candidates being reelected by state
